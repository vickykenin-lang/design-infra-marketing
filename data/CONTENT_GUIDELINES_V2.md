...
2. **At least one conversion signal** (minimum one of the following):
   ...
   - Typical timeline for that scope
   - What is included vs excluded in a turnkey package
   - Warranty / post-handover support mention
   - Concrete process step (e.g. “design freeze → material shortlist → site start”)

3. **No empty claims**
   - “No hidden costs” without any number or sample breakdown is forbidden.
   - “One team, zero hassle” is brand language — it must be paired with a concrete proof element above.

4. **Lead path clarity**
   - Soft CTA only: “Free consultation — link in bio.”
   - Never invent urgency or “DM now!!!” tone.

5. **Pillar balance (rolling weekly)**
   - Design Tips & Mistakes — 30%
   - Before/After & Concepts — 25%
   - Budget & Process Transparency — 20% (highest intent — do not under-invest)
   - Trends & Festive — 15%
...
- Does this card contain real proof or an honest concept label?
- Does it contain at least one conversion signal (price / timeline / inclusion / warranty / process)?
- Would a comparison shopper shortlist Design Infra after seeing only this post?

If any answer is “no”, the card is reworked — it does not enter the Founder’s approval queue.
